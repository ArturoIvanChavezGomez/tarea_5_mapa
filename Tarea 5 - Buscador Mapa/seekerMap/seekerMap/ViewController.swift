...
class ViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate, UISearchBarDelegate {
    ...
    @IBAction func ubicationButton(_ sender: UIBarButtonItem) {
        ...
        globalLocation = CLLocation(latitude: location.latitude, longitude: location.longitude)
        ...
        if let direction = seekerBarSearchBar.text {
            geocoder.geocodeAddressString(direction) { [self] (places: [CLPlacemark]?, error: Error?) in
                ...
                if error == nil {
                    ...
                    print("Destino \(String(describing: globalDestination))")
                    
                    print("Origen \(String(describing: globalLocation))")
                    ...
                    let alert = UIAlertController(title: "Distance", message: "Distance between origin and destination is: \(distance) meters.", preferredStyle: .alert)
